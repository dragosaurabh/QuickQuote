  ...
  theme: {
    extend: {
      colors: {
        ...
        // Creative-themed colors for photographer
        primary: '#F97316',
        secondary: '#EC4899',
        accent: '#8B5CF6',
      ...
      backgroundImage: {
        'gradient-halloween': 'linear-gradient(135deg, #F97316 0%, #8B5CF6 100%)',
        'gradient-spooky': 'linear-gradient(180deg, rgba(249, 115, 22, 0.1) 0%, transparent 50%)',
      },
    },
  },
  plugins: [],
