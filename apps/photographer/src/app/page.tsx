  ...
  return (
    <main className="min-h-screen bg-background">
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="absolute bottom-20 left-1/4 text-5xl opacity-20 animate-pulse delay-500">🎃</div>
        ...
        <div className="relative max-w-6xl mx-auto px-4 py-24 sm:py-32">
          <div className="text-center">
            ...
            <p className="text-xl sm:text-2xl text-text-muted mb-4">
              Create hauntingly good quotes for your photography clients
            </p>
            <p className="text-lg text-text-muted/80 mb-12 max-w-2xl mx-auto">
              Professional price quotes that capture the moment! 
              Share instantly via WhatsApp and book more shoots faster than a flash.
            </p>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <FeatureCard
              ...
              description="Create quotes in seconds with pre-saved packages and client info."
              color="purple"
            />
            <FeatureCard
              icon="📱"
      ...
      <section className="py-16 px-4 bg-gradient-to-r from-halloween-purple/20 to-halloween-orange/20">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-text-muted mb-8">
            Join fellow photographers who have already made their quoting process spooktacular!
          </p>
          <Button
            variant="primary"
            size="lg"
